...
class Sim_finder:
    ...
    def ft_word_similarity(self, word1, word2, choice=max):
        ...
        if word1 not in self.fasttext_model.key_to_index or word2 not in self.fasttext_model.key_to_index: return 0
    ...
    def gl_word_similarity(self, word1, word2, choice=max):
        ...
        if word1 not in self.glove_model.key_to_index or word2 not in self.glove_model.key_to_index: return 0
