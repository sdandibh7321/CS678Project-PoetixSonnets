...
from transformers import BeamScorer, PretrainedConfig, GPT2LMHeadModel, StoppingCriteriaList, LogitsProcessorList, MaxLengthCriteria
# from transformers import StoppingCriteria, validate_stopping_criteria
# from transformers.generation_utils import BeamSearchDecoderOnlyOutput, BeamSearchEncoderDecoderOutput, BeamSearchOutput
from transformers.generation import BeamSearchDecoderOnlyOutput, BeamSearchEncoderDecoderOutput
# from transformers. BeamSearchOutput
...
class CustomGPT2Model(GPT2LMHeadModel):
    ...
    #     **model_kwargs,
    # ) -> Union[Union[BeamSearchEncoderDecoderOutput, BeamSearchDecoderOnlyOutput], torch.LongTensor]:
    #     r"""
